...
public class Menu {
    ...
    private final CheckTicket checkTicket = new CheckTicket();
    private final MyCollection myCollection = new MyCollection();
    private final Recommend recommend = new Recommend();
    private final TicketPurchase ticketPurchase = new TicketPurchase();
    private final UserAccount userAccount = new UserAccount();
    private final CinemaManage cinemaManage = new CinemaManage();
    private final EarningView earningView = new EarningView();
    private final HallManage hallManage = new HallManage();
    private final MovieManage movieManage = new MovieManage();
    ...
    public void adminMenu() {
        ...
        while (flag < 100) {
            ...
            switch (choice) {
                case "1":
                    cinemaManage.cinemaManege();
                    break;
                case "2":
                    hallManage.hallManage();
                    break;
                case "3":
                    movieManage.movieManage();
                    break;
                case "4":
                    sessionManage.sessionManage();
                    break;
                case "5":
                    earningView.earningView();
                    break;
                default:
                    if (!MyUtil.isGoOn("是否退出登录(y/n)", "y")) {
                        flag = 100;
    ...
    public void UserMenu(int uid) {
        ...
        while (flag < 100) {
            ...
            switch (choice) {
                case "1":
                    movieManage.queryMovie();
                    break;
                case "2":
                    myCollection.myCollection(uid);
                    break;
                case "3":
                    ticketPurchase.ticketPurchaseByMovie(uid);
                    break;
                case "4":
                    checkTicket.checkTicket(uid);
                    break;
                case "5":
